...
export const products: Product[] = [
  ...
  },
  {
    slug: 'liOS',
    name: 'LiOS',
    tagline: { en: 'African Ecommerce Operating System', fr: "Système d'exploitation e-commerce africain" },
    description: {
      en: 'Launch your online store, manage orders, customers and products, and accept payments across Africa — all from one place.',
      fr: 'Lancez votre boutique en ligne, gérez commandes, clients et produits, et encaissez les paiements partout en Afrique — depuis un seul endroit.',
    },
    category: { en: 'Ecommerce', fr: 'E-commerce' },
    available: true,
    appUrl: 'https://lios.liafrik.com',
    icon: Store,
    ...
    dashboard: {
      title: { en: 'LiOS Store', fr: 'Boutique LiOS' },
    ...
    dashboard: {
      ...
      panels: [
        ...
        { kind: 'list', title: { en: 'Hot leads', fr: 'Leads chauds' }, items: [
          ...
          { label: { en: 'Lagos Pharma Ltd.', fr: 'Lagos Pharma Ltd.' }, value: '$22k', sub: 'Proposal' },
  ...
  },
  {
    slug: 'hr',
    name: 'HR Management',
    tagline: { en: 'Human Resources Platform', fr: 'Plateforme de gestion des ressources humaines' },
    description: {
      en: 'Manage employees, payroll, attendance and performance from one place — built for African labor realities.',
      fr: 'Gérez employés, paie, présences et performances depuis un seul endroit — pensé pour les réalités africaines du travail.',
    },
    category: { en: 'Human Resources', fr: 'Ressources humaines' },
    available: true,
    appUrl: 'https://hr.liafrik.com',
    icon: Users,
    ...
    dashboard: {
      title: { en: 'HR Dashboard', fr: 'Tableau de bord RH' },
  ...
  },
  {
    ...
    tagline: { en: 'Education Administration Platform', fr: "Plateforme d'administration scolaire" },
    description: {
      en: 'Run your school from enrollment to exams — students, teachers, classes, finance and parent communication in one place.',
      fr: 'Pilotez votre école des inscriptions aux examens — élèves, enseignants, classes, finances et communication parents au même endroit.',
    },
    category: { en: 'Education', fr: 'Éducation' },
    available: true,
    appUrl: 'https://school.liafrik.com',
    icon: GraduationCap,
    ...
    dashboard: {
      title: { en: 'School Dashboard', fr: 'Tableau de bord école' },
  ...
  },
  {
    ...
    tagline: { en: 'Food Service Operations Platform', fr: 'Plateforme de gestion de restauration' },
    description: {
      en: 'Take orders, run the kitchen display, manage tables and inventory — everything a modern restaurant needs.',
      fr: "Prenez les commandes, pilotez la cuisine, gérez les tables et les stocks — tout ce qu'un restaurant moderne nécessite.",
    },
    category: { en: 'Restaurants', fr: 'Restauration' },
    available: true,
    appUrl: 'https://restaurant.liafrik.com',
    ...
    dashboard: {
      title: { en: 'Restaurant Dashboard', fr: 'Tableau de bord restaurant' },
  ...
  },
  {
    ...
    dashboard: {
      title: { en: 'Hospital Dashboard', fr: 'Tableau de bord hôpital' },
    ...
    dashboard: {
      ...
      panels: [
        ...
        { kind: 'progress', title: { en: 'Top groups progress', fr: 'Progression des top groupes' }, progress: [
          ...
          { label: { en: 'Lagos Savers', fr: 'Lagos Savers' }, value: 52, color: '#00BFE0' },
        ]},
        { kind: 'list', title: { en: 'Recent payouts', fr: 'Versements récents' }, items: [
          ...
          { label: { en: 'Lagos Savers — Round 3', fr: 'Lagos Savers — Tour 3' }, value: '$5,600', sub: 'Processing' },
        ]},
      ],
    },
    pricing: [
  ...
  },
  {
    slug: 'digital-skills',
    name: 'Digital Skills',
    tagline: { en: 'Online Learning Platform', fr: "Plateforme d'apprentissage en ligne" },
    description: {
      en: 'A learning platform built for African talent — courses, certifications, progress tracking and expert instructors.',
      fr: "Une plateforme d'apprentissage pensée pour les talents africains — cours, certifications, suivi de progression et instructeurs experts.",
    },
    category: { en: 'Education', fr: 'Éducation' },
    available: false,
    icon: MonitorPlay,
    ...
    dashboard: {
      title: { en: 'Learning Dashboard', fr: 'Tableau de bord apprentissage' },
  ...
  },
  {
    slug: 'mafo',
    name: 'Mafo',
    tagline: { en: "Women's Health & Wellness", fr: 'Santé et bien-être féminin' },
    description: {
      en: 'A dedicated platform for women — menstrual cycle tracking, personalized advice, reminders and trusted health resources.',
      fr: 'Une plateforme dédiée aux femmes — suivi du cycle menstruel, conseils personnalisés, rappels et ressources santé de confiance.',
    },
  ...
  },
  {
    slug: 'books',
    name: 'Books',
    tagline: { en: 'Professional Accounting', fr: 'Comptabilité professionnelle' },
    description: {
      en: 'Run invoices, accounting, financial reports and tax compliance — the complete accounting platform for African businesses.',
      fr: 'Gérez factures, comptabilité, rapports financiers et conformité fiscale — la plateforme comptable complète pour les entreprises africaines.',
    },
    ...
    dashboard: {
      title: { en: 'Books Dashboard', fr: 'Tableau de bord comptable' },
...
export const sectors: Sector[] = [
  {
    ...
    icon: ShoppingCart,
    productSlugs: ['pos', 'liOS', 'crm', 'books'],
  },
  {
    id: 'education',
    name: { en: 'Education', fr: 'Éducation' },
    icon: GraduationCap,
    productSlugs: ['school', 'digital-skills', 'hr'],
  },
  {
    id: 'healthcare',
    name: { en: 'Healthcare', fr: 'Santé' },
    icon: HeartPulse,
    productSlugs: ['health-core', 'mafo'],
  },
  {
    id: 'restaurant',
    name: { en: 'Restaurants', fr: 'Restauration' },
    icon: UtensilsCrossed,
    productSlugs: ['restaurant', 'pos', 'books'],
  },
  {
    id: 'realestate',
    name: { en: 'Real Estate', fr: 'Immobilier' },
    icon: Building2,
    productSlugs: ['bailly', 'books', 'crm'],
  },
  {
    id: 'finance',
    name: { en: 'Cooperative & Finance', fr: 'Coopérative & Finance' },
    icon: PiggyBank,
    productSlugs: ['kolo', 'books'],
  },
];
