...
export const products: Product[] = [
 ...
 tagline: { en: 'Learning Marketplace', fr: 'Marketplace de formation' },
  ...
  },
  {
    ...
    pricing: [
      { name: { en: 'Seller', fr: 'Vendeur' }, price: '$0', period: 'mo', description: { en: 'Free to list, pay per sale.', fr: 'Gratuit pour lister, payez à la vente.' }, features: [
        { en: 'Unlimited listings', fr: 'Annonces illimitées' },
        { en: 'Buyer protection', fr: 'Protection acheteur' },
        { en: 'Mobile-first checkout', fr: 'Paiement mobile-first' },
        { en: 'Seller dashboard', fr: 'Tableau de bord vendeur' },
      ], cta: { en: 'Start selling', fr: 'Commencer à vendre' } },
      { name: { en: 'Pro Seller', fr: 'Vendeur Pro' }, price: '$29', period: 'mo', popular: true, description: { en: 'For growing brands and boutiques.', fr: 'Pour les marques et boutiques en croissance.' }, features: [
        { en: 'Lower transaction fees', fr: 'Frais de transaction réduits' },
        { en: 'Seller analytics', fr: 'Analyses vendeur' },
        { en: 'Featured listings', fr: 'Annonces mises en avant' },
        { en: 'Priority support', fr: 'Support prioritaire' },
      ], cta: { en: 'Start free', fr: 'Commencer' } },
      { name: { en: 'Enterprise', fr: 'Enterprise' }, price: 'Custom', description: { en: 'For large multi-brand groups.', fr: 'Pour les grands groupes multi-marques.' }, features: [
        { en: 'Dedicated account manager', fr: 'Gestionnaire de compte dédié' },
        { en: 'API access', fr: 'Accès API' },
        { en: 'Custom integrations', fr: 'Intégrations sur mesure' },
        { en: 'SLA', fr: 'SLA' },
      ], cta: { en: 'Contact sales', fr: 'Contacter les ventes' } },
    ],
  },
