        ...
        <div className="grid sm:grid-cols-3 lg:grid-cols-4 gap-8 pt-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              ...
              <li><a href="mailto:cs@liafrik.com" className="text-sm text-ink-muted hover:text-liafrik-700 transition-colors">{lang === 'en' ? 'Customer Service' : 'Service client'}</a></li>
