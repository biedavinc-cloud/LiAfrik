...
export default function PrivacyPolicy() {
  ...
  const sections = en ? [
    ...
    { title: '3. SaaS-Specific Data Processing', body: 'Each LiAfrik platform processes specific categories of data: OS and POS process orders and customer data; Health processes patient and medical records; Faka processes employee and HR data; LiBooks processes financial and accounting data; Kolo processes community savings and contribution data; Mafo processes women\'s health data. All sensitive data is encrypted and access-controlled.' },
    ...
    { title: '3. Traitement des données par SaaS', body: 'Chaque plateforme LiAfrik traite des catégories spécifiques de données : OS et POS traitent les commandes et données clients ; Health traite les dossiers patients et médicaux ; Faka traite les données employés et RH ; LiBooks traite les données financières et comptables ; Kolo traite les données d\'épargne communautaire ; Mafo traite les données de santé féminine. Toutes les données sensibles sont chiffrées et à accès contrôlé.' },
