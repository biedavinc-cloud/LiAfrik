...
export default function TermsOfService() {
  ...
  const sections = en ? [
    ...
    { title: '4. Intellectual Property', body: 'LiAfrik, including its platform names (Sellia, POS, CRM, Atlas, LiBooks, Faka, Health, Mafo, Kolo, Bailly, Skills, Klasoo, Nutro, Zando, Litrek), logos, designs, and software, is the property of LiAfrik. You retain full ownership of all data you create within our platforms.' },
    ...
    { title: '4. Propriété intellectuelle', body: 'LiAfrik, y compris les noms de ses plateformes (Sellia, POS, CRM, Atlas, LiBooks, Faka, Health, Mafo, Kolo, Bailly, Skills, Klasoo, Nutro, Zando, Litrek), logos, designs et logiciels, est la propriété de LiAfrik. Vous conservez la pleine propriété de toutes les données que vous créez dans nos plateformes.' },
